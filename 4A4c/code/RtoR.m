...
% q = smoothdata(q, "gaussian", 10);
% ele = smoothdata(ele, "gaussian", 10);
...
figure
plot(t, q, 'DisplayName','Yaw Rate')
hold on;
plot(t, ele, 'DisplayName','Rudder Angle')
legend
ylabel("Normalised Amplitude")
xlabel("Time")
saveas(gcf,'figs/RtoR_IO','epsc')
...
plot(tp, q, 'DisplayName','Yaw Rate')
hold on
plot(tt(1:n-1, 1), yy(1:n-1, 1), 'DisplayName','Simulated')
% 
% hold on
% plot(tp, ele, 'DisplayName','Rudder')
% hold on

legend()
ylabel("")
xlabel("time")
saveas(gcf,'figs/RtoR_Sim','epsc')

figure
rlocus(-EtoQ);
grid on
saveas(gcf,'figs/RtoR_rlocus','epsc')

figure
bode(EtoQ);
grid("minor")
saveas(gcf,'figs/RtoR_bode','epsc')
